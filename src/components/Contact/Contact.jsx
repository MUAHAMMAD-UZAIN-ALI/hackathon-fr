                ...
                <div className="contact-grid">
                    ...
                    <form className="contact-form">
                        <div className="form-group">
                            ...
                            <input type="text" name="name" id="name" placeholder="Full Name" className="form-input" />
                        </div>
                        ...
                        <div className="form-group">
                            ...
                            <input type="tel" name="tel" id="tel" placeholder="Telephone Number" className="form-input" />
                        </div>
